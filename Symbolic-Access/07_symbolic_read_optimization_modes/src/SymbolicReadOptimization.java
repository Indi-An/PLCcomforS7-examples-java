...
/**
 * SymbolicReadOptimization (Java 11)
 *
 * Demonstrates:
 ...
 */
public class SymbolicReadOptimization implements IProjectImportProgressChangedCallback {

    public static void main(String[] args) {
        var instance = new SymbolicReadOptimization();
    ...
    private void program(String[] args) {
        ...
        try {
            ...
            // If you switch to SMART, note that SMART requires Tls13Device (TLS).
